<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="IncidenceList.aspx.cs" Inherits="CentralitaOS.Web.Admin.IncidenceList" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#Incidences').DataTable({
                'bProcessing': true,
                'bServerSide': true,
                'sAjaxSource': '/Admin/IncidenceServiceList.ashx',
                ...
                "columnDefs": [
                    {
                        "render": function (data, type, row) {
                            return "<a href='/Admin/IncidenceEdit?id=" + row.Id + "' class='btn btn-pink'>" + data + "</a>";
                        },
                        "targets": 0
                    },
                    {
